...
db.Book.deleteMany({}, function(err, books){
  ...
  //what does deleteMany really mean? is it a keyword or dummy word
  if(err) {
...
//AFTER A SEED FILE RUN YOU WANT AN EXIT! so process.exit();
//process.exit() is a node file (similar to exports)
//look into MDN docs for node files