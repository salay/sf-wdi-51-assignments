...
-- closest is Italy and San Marino

-- SELECT * FROM city WHERE countrycode = 'SMR' ORDER BY name;
-- Italy doesn't have a city named Italy or Italia or anything close to Italy.
-- San Marino has a capital named San Marino.
-- The other city is named Serravalle

-- SELECT * FROM city WHERE name LIKE 'Ser%';
-- Serra, BRA is like Serravalle
